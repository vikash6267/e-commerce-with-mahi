          ...
          <div className="lg:w-[78%] w-full bg-white p-4 min-h-screen">
            ...
            <div className=" border-b-2 pb-2 ">
              <div className="flex justify-between">
                ...
                <div className="">
                  {(selectedGender !== "" || selectedSizes.length > 0) && (
                    <button onClick={resetFilter} className=" ">
                      Reset Filters
                    </button>
                  )}
                </div>
              ...
              <div className=" flex gap-8 mt-3">
                <div>
                  {selectedGender !== "" && (
                    <button className=" text-[13px] bg-gray-700 p-1 rounded-lg text-white flex items-center relative">
                      {" "}
                      {selectedGender}{" "}
                      <RxCross2
                        className=" absolute -right-2 -top-1 bg-red-700 rounded-full text-xsl"
                        onClick={() => {
                          setSelectedGender("");
                          if (selectedSizes.length == 0) {
                            resetFilter();
                ...
                <div className=" flex gap-8">
                  {selectedSizes.map((size, ind) => (
                    <button
                      key={ind}
                      className=" text-[13px] bg-gray-700 p-1 rounded-lg text-white flex items-center relative"
                    >
                      {" "}
                      {size}{" "}
                      <RxCross2
            ...
            {filteredProducts.length === 0 ? (
              ...
              <div
                className={`grid lg:grid-cols-${numOfColumns} lg:px-6 gap-2 sm:grid-cols-2 md:grid-cols-3 grid-cols-2`}
              >
