        ...
        <>
          ...
          >
            ...
            <div className="container flex">
              {cartQuantity === 0 ? (
                <EmptyView icon={<BsCartX />} msg="Your Cart is Empty" btnText="Start Shopping" />
              ) : (
                  ...
                  <div className="w-full mb-[5.2rem] text-gray-500 font-montserrat">
                    <div className="flex flex-col">
                      <h3 className="font-montserrat text-sm font-medium">
                        Total &nbsp; ({cartQuantity} {cartQuantity > 1 ? 'items' : 'item'})
                      </h3>
                      ...
                      <button
                        type="button"
                        className="w-11/12 bg-gray-900 hover:bg-gray-950 hover:scale-105 text-white p-2 mt-3 rounded-xl mx-auto font-bold"
                      >
                        Checkout
                      </button>
                    </div>
