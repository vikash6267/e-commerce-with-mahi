...
const PrivacyPolicy = () => {
  ...
  return (
    <div className="max-w-3xl mx-auto p-6 bg-white rounded-lg shadow-md mt-[70px]">
      <h1 className="text-3xl font-bold mb-4 text-gray-900">Privacy Policy for Absence Apparels</h1>
      <p className="text-gray-700 mb-6 leading-relaxed">
        At Absence Apparels, we are dedicated to safeguarding your personal information. This Privacy Policy outlines how we collect, use, disclose, and protect your information when you interact with our website, mobile application, and other services.
      </p>
