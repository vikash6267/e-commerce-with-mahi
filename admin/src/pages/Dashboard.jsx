...
//   const getYearlyDataFun = async () => {
  
//     const yearlyData = await getYearlyData(token)
//     console.log(yearlyData)
//     if (yearlyData.length > 0) {
//       console.log("categories", yearlyData)
//       setYearlyDataState(yearlyData)
//     }
   
//   }

//   const getMonthlyDataFun = async () => {
  
//     const monthlyData = await getMonthlyData(token)
